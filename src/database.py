...
def connect():
	...
	logging.info(str(now) + " Connecting to database " + db_name + " using credentials " + db_user +"@"+ db_host +":" + db_pass)

	try:
		con = psycopg2.connect("dbname=" + db_name + " host=" + db_host + " user=" +db_user+ " password="+db_pass)
